<header class="header">
    <g:link controller="landing" action="index" class="logo">
        <g:message code="application.main.title"/>
    </g:link>
            ...
            %{--<ul class="nav navbar-nav">--}%
                %{--<li class="dropdown">--}%
                    %{--<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"--}%
                       %{--aria-expanded="false">--}%
                        %{--<g:message code="main.menu.general.management.menu"/> <span class="caret"></span></a>--}%
                    %{--<ul class="dropdown-menu" role="menu">--}%
                        %{--<li>--}%
                            %{--<g:link controller="accounts" action="manageAccounts">--}%
                                %{--<g:message code="accounts.management.main.menu.item"/>--}%
                            %{--</g:link>--}%
                        %{--</li>--}%
                        %{--<li>--}%
