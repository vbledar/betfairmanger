<menu:navMenu controller="accounts" action="manageAccounts" name="${message(code: 'accounts.management.main.menu.item')}" icon="fa fa-user-md"/>

<menu:navMenu controller="countries" action="manageCountries" name="${message(code: 'countries.management.main.menu.item')}" icon="fa fa-flag"/>
